package com.ycjcjy.gene.web.action.upload;
...
public class UpLoadFileController {
    ...
    public CkEditerUploadCallBackVo filebrowserBrowseUrl(@RequestParam("upload") MultipartFile file, HttpServletRequest request, CkEditerUploadCallBackVo vo) throws Exception{
        ...
        if (ImageUtil.checkImage(allPath)&&!contentType.contains("gif")){
    ...
    private String zipImage(String beforePath,String afterPath){
        ...
        ImageZipUtil.zipImageFile(before,after,ImageUtil.getImgWidth(before),ImageUtil.getImgHeight(before),Float.valueOf(PropUtil.getConfig("aliyun.oss.zipimg.limit.quality")));
