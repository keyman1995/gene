...
import com.ycjcjy.gene.VO.MenuTree;
...
public class SysPremissionController extends TlBaseController<SysPermission,SysPermissionService> {
    ...
    public PageResult<MenuTree> getRolePremission(@RequestParam(value = "roleId") Long roleId, PageResult<MenuTree> result){
        //查出url和menu的数据
        List<SysPermission> list = baseService.findChildSync(null,false);
