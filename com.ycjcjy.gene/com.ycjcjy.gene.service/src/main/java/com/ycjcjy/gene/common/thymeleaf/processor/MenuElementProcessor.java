...
import com.ycjcjy.gene.service.impl.SysPermissionServiceImpl;
...
public class MenuElementProcessor extends OneBeanBaseAbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
        ...
        inputStart = modelFactory.setAttribute(inputStart,"onclick","modalmenuTree("+selfId+","+businessIputId+")");
