...
import com.ycjcjy.gene.service.SysOrganizationService;
import com.ycjcjy.gene.service.impl.SysOrganizationServiceImpl;
...
public class OrgTreeProcessor extends OneBeanBaseAbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
        ...
        final String businessIputId = tag.getAttributeValue("businessIputId");
        ...
        inputStart = modelFactory.setAttribute(inputStart,"onclick","modalOrgTree("+selfId+","+businessIputId+")");
        ...
        if (pid == null || pid.equals("0")) {
            ...
            inputStart = modelFactory.setAttribute(inputStart,"value",sysOrganizationService.findById(pid).getOrg_name());
        }
