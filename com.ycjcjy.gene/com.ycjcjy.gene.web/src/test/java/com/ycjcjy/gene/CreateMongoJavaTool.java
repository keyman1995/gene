...
public class CreateMongoJavaTool {
	...
	protected void initPath(){
		...
		modelPath = workspacePath +"com.ycjcjy.gene.dao\\src\\main\\java\\com\\ycjcjy\\gene\\model\\mongo\\";
		daoPath = workspacePath + "com.ycjcjy.gene.dao\\src\\main\\java\\com\\ycjcjy\\gene\\dao\\mongo\\";
		servicePath = workspacePath + "com.ycjcjy.gene.service\\src\\main\\java\\com\\ycjcjy\\gene\\service\\mongo\\";
		serviceImplPath = workspacePath + "com.ycjcjy.gene.service\\src\\main\\java\\com\\ycjcjy\\gene\\service\\impl\\mongo\\";
	...
	protected void executeModel(){
		try {
			StringBuffer sb = new StringBuffer("package com.ycjcjy.gene.model.mongo;\n\nimport net.onebean.core.model.BaseModelMongo;");
	...
	protected void executeDao(){
		try {
			StringBuffer sb = new StringBuffer("package com.ycjcjy.gene.dao.mongo;\n\nimport org.springframework.stereotype.Component;"
			+"\nimport com.ycjcjy.gene.model.mongo."+modelName()+";"
			+"\nimport BaseMongoDao;");
			sb.append("\n\n@Component");
	...
	protected void executeService(){
		try {
			StringBuffer sb = new StringBuffer(" package com.ycjcjy.gene.service.mongo;\n\nimport IBaseMongoBiz;"
			+"\nimport com.ycjcjy.gene.model.mongo."+modelName()+";");
	...
	protected void executeServiceImpl(){
		try {
			StringBuffer sb = new StringBuffer("package com.ycjcjy.gene.service.impl.mongo;\n\nimport org.springframework.stereotype.Service;"
					+ "\nimport BaseMongoBiz;"
					+ "\nimport com.ycjcjy.gene.model.mongo."+modelName()
					+";\nimport com.ycjcjy.gene.service.mongo."+modelName()+"Service;"
					+ "\nimport com.ycjcjy.gene.dao.mongo."+modelName()+"Dao;");
			sb.append("\n\n@Service");
